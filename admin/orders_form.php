...
<div class="form-container">
  ...
  <div class="card">
    <form id="order-form" method="POST" autocomplete="off" class="form-stack">
      
      <div class="form-row">
        <div class="form-group">
          <label class="form-label">Penghuni</label>
          <select class="filter-select-full" id="no-cust" name="customer" required>
        ...
        <div class="form-group">
          ...
          <select class="filter-select-full" id="no-room" name="room" required onchange="calculateEndAndTotal()">
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <select class="filter-select-full" id="no-type" name="type" required onchange="calculateEndAndTotal()">
      ...
      <div class="order-summary">
        <div class="order-summary-label">RINGKASAN ORDER</div>
        <div class="order-summary-row">
          <span class="text-muted">Total</span>
          <span id="no-total-display" class="order-summary-total">Rp 0</span>
        </div>
        <input type="hidden" id="no-total" name="total" value="0" />
      </div>

      <div class="form-actions">
        <a href="orders.php" class="btn btn-secondary btn-link">Batal</a>
